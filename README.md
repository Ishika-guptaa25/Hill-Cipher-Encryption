...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Made%20with%20❤%20by-Ishika%20Gupta-FF69B4?style=for-the-badge"/>
</p>
...
│
├── hill_cipher.py → Core algorithm (encryption & decryption)
├── streamlit_app.py → Streamlit UI file
├── requirements.txt → Python dependencies
├── .gitignore → Ignored system/venv/cache files
...
🌐 Try It Online
🚀 Launch the app instantly on Streamlit:
👉 Try Online (Click Here)

(Replace with your Streamlit Cloud link once deployed.)
...
👩‍💻 Author
Ishika Gupta
🎓 BCA Student | Python Developer | Aspiring Cabin Crew
📍 India
